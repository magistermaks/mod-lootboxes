...
public class LootBoxes implements ModInitializer {
	...
	public static final Item URN_ITEM = new BlockItem(URN_BLOCK, new Item.Settings().group(ItemGroup.DECORATIONS).rarity(Rarity.UNCOMMON));

	@Override
	public void onInitialize() {
		Registry.register(Registry.BLOCK, id("urn"), URN_BLOCK);
		Registry.register(Registry.ITEM, id("urn"), URN_ITEM);
