...
public abstract class LootBoxBlock extends Block implements DefaultLoot, Waterloggable {
	...
	@Override
	public List<ItemStack> getDefaultStacks(BlockState state, LootContextParameterSet.Builder builder, Identifier identifier, LootContextParameterSet set, ServerWorld serverWorld, LootTable lootTable) {
